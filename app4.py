...
def pagina_principal():
    ...
    if request.method == 'POST':
        ...
        if pergunta_atual < len(questoes_e_respostas):
            ...
            # Se todas as perguntas foram respondidas, redirecionar para uma página de conclusão
    ...
    # Se pergunta_atual for inválido, redirecionar para uma página de conclusão
    return redirect(url_for('conclusao'))
...
def conclusao():
    ...
    return "Parabéns! Você concluiu o quiz."
